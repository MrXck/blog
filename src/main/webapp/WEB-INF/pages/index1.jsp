        ...
        <div class="col-xs-12">
            <div class="col-xs-9">
                <div class="panel panel-default">
                    <div class="panel-heading" id="panel-heading">博客 <c:if test="${num > 0}"><span class="pull-right">共${num}篇</span></c:if></div>
...
<%--                                    </span>--%>
        ...
        <c:if test="${pageInfo.hasNextPage}">
            <a style="" class="col-xs-offset-7 btn btn-default" href="${pageContext.request.contextPath}/index?page=${pageInfo.nextPage}">下一页</a>
        </c:if>
    </div>
</div>
</body>
